            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('etudiants') }}" :active="request()->routeIs('etudiants')">
                     ...
                     <x-nav-link href="{{ route('add_etudiants') }}" :active="request()->routeIs('add_etudiants')">
                        {{ __('Ajouter étudiant') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('classe') }}" :active="request()->routeIs('classe')">
                        {{ __('Classes') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('parcour') }}" :active="request()->routeIs('parcour')">
                        {{ __('Parcours') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('matiere') }}" :active="request()->routeIs('matiere')">
                        {{ __('Matières') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('enseignant') }}" :active="request()->routeIs('enseignant')">
                        {{ __('Enseignants') }}
                    </x-nav-link>
                </div>
            </div>
