<div>
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                    <div class="px-4 py-8 mb-4 bg-white shadow sm:rounded-lg sm:px-10">
                        <form method="POST" wire:submit.prevent="save">
                            <div>
                                <label for="email" class="block text-sm font-medium leading-5 text-gray-700">Classe</label>
                                <div class="relative mt-1 rounded-md shadow-sm">
                                    <input id="name" wire:model="name" placeholder="Nom de classe" type="text"
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm font-medium whitespace-nowrap">
                                ...
                                <button wire:click="destroy({{$classe->id}})" class="ml-2 text-red-600 hover:text-red-900">Delete</button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                ...
                @else
                <p class="text-center text-red-600">Aucun classe</p>
                @endif
            </div>
        </div>
    </div>   
